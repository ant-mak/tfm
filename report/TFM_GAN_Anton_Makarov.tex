...
O = \frac{W-K+2P}{S}+1,
\end{equation*}
donde $W$ es el ancho, $K$ el tamaño del filtro, $P$ el padding y $S$ el stride. En nuestro ejemplo, por tanto, tendremos un tamaño de salida $O = \frac{5-3+2}{2}+1 = 3$. En general se suele utilizar más de un filtro en cada capa convolucional, obteniendo así también dimensiones de profundidad.
...
O = S(W-1)+K-2P,
\end{equation*}
donde $W$ es el ancho, $K$ el tamaño del filtro, $P$ el padding y $S$ el stride.
